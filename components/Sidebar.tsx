...
import {
  ImageIcon, VideoIcon, SettingsIcon, BookOpenIcon, LogoutIcon, GalleryIcon, LogoIcon, XIcon, LibraryIcon, FileTextIcon, GraduationCapIcon, TrendingUpIcon, RobotIcon, MegaphoneIcon, DatabaseIcon, WhatsAppIcon, ActivityIcon, UsersIcon
} from './Icons';
...
const getNavItems = (language: Language): NavItem[] => {
    ...
    return [
        ...
        { id: 'ugc-generator', label: "UGC Generator", section: 'free', icon: UsersIcon, isNew: true },
